...
import { createTransformer } from '../../utils/transformBookmarks'
...
const App = (): JSX.Element => {
  ...
  const handleCopy = async () => {
    ...
    const transform = createTransformer({ isObsidianFormat, isDoubleSpaced })
    const md = bookmarks.map((b) => transform(b, 0)).join('')
